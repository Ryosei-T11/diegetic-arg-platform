...
// =========================================================================
// 1. LOGIKA INTI & UTILITAS KRIPTOGRAFI (Asalnya dari core/crypto & gameState)
// =========================================================================
...
// =========================================================================
// 3. KOMPONEN ELEMEN UI JENDELA OS (components/Window)
// =========================================================================
...
// =========================================================================
// 4. KOMPONEN TERMINAL FORENSIK (components/Terminal)
// =========================================================================
...
// =========================================================================
// 5. KOMPONEN KOTAK SUREL DETEKTIF (components/EmailClient)
// =========================================================================
...
// =========================================================================
// 6. KUMPULAN SITUS WEB PALSU DI "INTERNET SIMULASI" (mock-internet/)
// =========================================================================

export function KorbanBlog({ gameState, onUnlockJournal, playSound, onNavigate }) {
...
export function ForumHome({ playSound, onNavigate }) {
...
export function MegaCorpSitus({ url, gameState, onHackMegaCorp, playSound, onNavigate, onOpenWindow }) {
...
// =========================================================================
// 7. KOMPONEN PERAMBAN WEB (components/Browser)
// =========================================================================
...
// =========================================================================
// 8. KOMPONEN PECAH SANDI OTOMATIS (components/CryptoTool)
// =========================================================================
...
// =========================================================================
// 9. APLIKASI UTAMA (State management, Drag, Taskbar, Workspace)
// =========================================================================
    ...
    >
      ...
      <header className="absolute top-0 left-0 right-0 h-11 bg-slate-950/80 border-b border-slate-800/60 flex items-center justify-between px-5 z-50 backdrop-blur-md">
        ...
        <div className="flex items-center gap-5 text-xs font-mono">
          ...
          <button onClick={handleResetGame} className="px-2 py-1 bg-red-950/40 hover:bg-red-900/60 text-red-400 border border-red-900/40 rounded transition-colors text-xs">
            Reset Progress
          </button>
        </div>
      </header>
      ...
      <main className="absolute inset-0 pt-16 pb-16 px-6 flex flex-col gap-5 items-start content-start flex-wrap z-10">
        ...
        <button onDoubleClick={() => openWindow('email', 'Klien Surel Forensik', 760, 480)} onClick={() => playSound('click')} className="group w-20 flex flex-col items-center gap-1.5 p-1.5 rounded-lg hover:bg-slate-900/40 text-center">
          <div className="relative w-12 h-12 bg-purple-500/10 rounded-lg border border-purple-500/30 flex items-center justify-center text-purple-400 shadow-lg text-2xl">
            ✉️
          </div>
